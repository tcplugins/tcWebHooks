...
/**
 * This class simply holds the actions available at
 * "/admin/manageWebHooksRestApi.html" Actions need to inject this class and
 * register themselves.
 */
public class WebHookRestApiActionController extends BaseAjaxActionController {
	...
	public WebHookRestApiActionController(@NotNull final WebControllerManager controllerManager) {
