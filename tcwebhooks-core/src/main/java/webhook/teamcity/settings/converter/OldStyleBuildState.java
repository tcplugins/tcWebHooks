...
public final class OldStyleBuildState {
    ...
    public static String getShortName(Integer stateInt) {
        ...
        if (stateInt.equals(BUILD_STARTED)) {
            return "buildStarted";
        }
        if (stateInt.equals(BUILD_FINISHED)) {
            return "buildFinished";
        }
        if (stateInt.equals(BUILD_CHANGED_STATUS)) {
            return "statusChanged";
        }
        if (stateInt.equals(BEFORE_BUILD_FINISHED)) {
            return "beforeBuildFinish";
        }
        if (stateInt.equals(RESPONSIBILITY_CHANGED)) {
            return "responsibilityChanged";
        }
        if (stateInt.equals(BUILD_INTERRUPTED)) {
    ...
    public static String getDescriptionSuffix(Integer stateInt) {
        ...
        if (stateInt.equals(RESPONSIBILITY_CHANGED)) {
            return "changed responsibility";
        }
        if (stateInt.equals(BUILD_INTERRUPTED)) {
            return "been interrupted";
        }
        return null;
    }
