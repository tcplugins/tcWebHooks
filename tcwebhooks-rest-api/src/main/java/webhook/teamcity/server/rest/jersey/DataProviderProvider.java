...
public class DataProviderProvider implements InjectableProvider<Context, Type>, Injectable<DataProvider> {
  ...
  {
	  dataProvider = new DataProvider(sBuildServer, rootUrlHolder, permissionChecker, payloadManager, templateManager, templateFinder, projectManager, webHookManager, webHookFinder, projectIdResolver);
  }
